"""SQLAlchemy migration environment."""
import os
import sys
...
# When running from parser directory, parent is project root
...
# Set the SQLAlchemy URL from environment variable or config file
